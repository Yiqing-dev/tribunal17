...
_CN_HOLIDAYS_2025 = {
    # New Year's Day
    "2025-01-01",
    # Spring Festival (Jan 28 除夕 – Feb 4)  [CNY = 2025-01-29]
...
_CN_HOLIDAYS_2026 = {
    # New Year's Day (Jan 1 – Jan 3, 复市 Jan 5)  [3-day per 国办 2026; 01-02 is the
    # missing trading-day closure, 01-03 is the Saturday]
    "2026-01-01", "2026-01-02", "2026-01-03",
    # Spring Festival (Feb 15 – Feb 23, 复市 Feb 24)  [正月初一 = 2026-02-17, 除夕 =
    # 02-16; 9-day per 上证公告〔2025〕45号 — 02-23 (周一·初七) was the missing closure]
    ...
    # Mid-Autumn Festival (八月十五 = 2026-09-25 周五; standalone 3-day, 复市 09-28)
    "2026-09-25",
    # National Day
