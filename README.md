...
| # | 智能体 | 代号 | 模型 | 并行 |
|---|--------|------|------|------|
| 1 | 宏观分析师 | **太史令** | sonnet | L1 三路并行 |
| 2 | 市场广度 | **户部司** | sonnet | L1 三路并行 |
| 3 | 板块轮动 | **舆图司** | sonnet | L1 三路并行 |
| 4 | 技术面分析师 | **观星司** | sonnet | L2 四路并行 |
| 5 | 基本面分析师 | **度支司** | sonnet | L2 四路并行 |
| 6 | 新闻分析师 | **通政司** | sonnet | L2 四路并行 |
| 7 | 情绪分析师 | **察言司** | sonnet | L2 四路并行 |
| 8 | 催化剂分析师 | **风信司** | sonnet | 串行 |
| 9 | 多头研究员 (×2 轮) | **主战派** | sonnet | 两路并行 |
| 10 | 空头研究员 (×2 轮) | **主和派** | sonnet | 两路并行 |
| 11 | 情景分析师 | **推演阁** | sonnet | 串行 |
| 12 | 研究总监 | **军机处** | **opus** | 串行 |
| 13 | 激进风控 | **锐卫** | sonnet | 三路并行 |
| 14 | 保守风控 | **盾卫** | sonnet | 三路并行 |
| 15 | 中性风控 | **衡卫** | sonnet | 三路并行 |
| 16 | 风控总监 | **御史台** | **opus** | 串行 |
| 17 | 交易输出 | **虎符令** | sonnet | 串行 |
